...
<xsl:param name="body.font.family">&arezzo;</xsl:param>
...
<xsl:param name="title.font.family">&stafford;</xsl:param>
...
<xsl:param name="metadata.producer"></xsl:param>
...
<xsl:param name="suse.doc.url">https://saigkill.tuxfamily.org</xsl:param>
